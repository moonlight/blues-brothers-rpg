...
void aphoton_init(void)
{
    ...
    MAKE_GRAY_RANGE(button_gray_range, int(235 * b), int(195 * b));
    button_border_gray = makecol(int(176 * b), int(176 * b), int(176 * b));

    container_black = makecol(int(75 * b), int(75 * b), int(75 * b));
    container_gray1 = makecol(int(177 * b), int(177 * b), int(177 * b));
    container_gray2 = makecol(int(201 * b), int(201 * b), int(201 * b));

    check_black = makecol(int(24 * b), int(24 * b), int(24 * b));
    check_gray1 = makecol(int(153 * b), int(153 * b), int(153 * b));
    check_gray2 = makecol(int(204 * b), int(204 * b), int(204 * b));

    MAKE_GRAY_RANGE(scrollbar_gray_range, int(195 * b), int(235 * b));
    scrollbar_gray1 = makecol(int(181 * b), int(181 * b), int(181 * b));
    scrollbar_gray2 = makecol(int(161 * b), int(161 * b), int(161 * b));

    edit_gray = makecol(int(192 * b), int(192 * b), int(192 * b));
    edit_white = makecol(int(244 * b), int(244 * b), int(244 * b));

    list_white = makecol(int(248 * b), int(248 * b), int(248 * b));
    list_green = makecol(int(142 * b), int(162 * b), int(155 * b));

    MAKE_GRAY_RANGE(menu_gray_range, int(197 * b), int(217 * b));
    menu_gray_from = MAKECOL_RANGE_FROM(menu_gray_range);
    menu_gray_to = MAKECOL_RANGE_TO(menu_gray_range);

    checked_gray = makecol(int(92 * b), int(92 * b), int(92 * b));

    slider_white1 = makecol(int(235 * b), int(235 * b), int(235 * b));
    slider_white2 = makecol(int(237 * b), int(237 * b), int(237 * b));
    slider_gray1 = makecol(int(140 * b), int(140 * b), int(140 * b));
    slider_gray2 = makecol(int(172 * b), int(172 * b), int(172 * b));
    slider_gray3 = makecol(int(108 * b), int(108 * b), int(108 * b));
    slider_gray4 = makecol(int(197 * b), int(197 * b), int(197 * b));
    slider_gray5 = makecol(int(162 * b), int(162 * b), int(162 * b));
    MAKE_GRAY_RANGE(slider_gray_range, int(237 * b), int(197 * b));

    window_black = makecol(int(63 * b), int(63 * b), int(63 * b));
    window_gray = makecol(int(157 * b), int(157 * b), int(157 * b));

    window_blue1 = makecol(int(142 * b), int(189 * b), int(255 * b));
    window_blue2 = makecol(int(92 * b), int(141 * b), int(223 * b));
    window_blue3 = makecol(int(42 * b), int(89 * b), int(173 * b));

    window_blue_range.from.r = int(102 * b);
    window_blue_range.from.g = int(149 * b);
    window_blue_range.from.b = int(233 * b);
    window_blue_range.to.r = int(71 * b);
    window_blue_range.to.g = int(118 * b);
    window_blue_range.to.b = int(202 * b);

    black = makecol(0, 0, 0);    
    white = makecol(int(255 * b), int(255 * b), int(255 * b));
    normal = makecol(int(216 * b), int(216 * b), int(216 * b));
    highlight = makecol(int(144 * b), int(152 * b), int(248 * b));
    shadow = makecol(int(127 * b), int(127 * b), int(127 * b));
