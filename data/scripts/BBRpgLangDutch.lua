...
BBRpgLangDutch = Lang:subclass
{
	...
	convs = {
		...
		Intro5 = {
			...
			{"Jake", "Wat?"},
			{"Elwood", "Deze auto. Deze kutauto. Waar is de Cadillac? De Caddy? Waar is de Caddy?"},
			{"Jake", "De wat?"},
		...
		Intro6 = {
			...
			{"Elwood", "Onze broer Brian? Maar we hebben geen andere broer! Helemaal geen Brian!"},
			{"Jake", "Hij is geadopteerd, nou je bek houden en me uit laten spreken!"},
			{"Elwood", "Ik kan maar niet begrijpen dat onze ouders het ons nooit verteld hebben..."},
			{"Jake", "Het jou nooit verteld hebben..."},
			{"Elwood", "Wat?"},
			{"Jake", "Ik kan maar niet begrijpen dat onze ouders het JOU nooit verteld hebben..."},
			{"Elwood", "Je bedoeld dat jij het altijd al geweten hebt?"},
			{"Jake", "Ja, maar laat je me nou eindelijk een keer uitspreken?!"},
			{"Jake", "Maar goed, onze broer Brian, ook wel bekend als The Brain, is twee weken geleden gearresteerd terwijl hij met een gestolen creditcard mini-raket motoren in een hobbywinkel kocht voor zijn mini versie van de Columbia Ruimteveer met schaal een op honderd, gemaakt van alleen maar mini-raket motoren, ducktape, gebruikte walkmans, oude houten ijsstokjes, fietsen en een autoband."},
