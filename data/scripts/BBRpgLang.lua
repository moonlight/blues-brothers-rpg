...
BBRpgLang = Lang:subclass
{
	...
	convs = {
		...
		Intro5 = {
			...
			{"Jake", "What?"},
			{"Elwood", "This car. This stupid car. Where's the Caddy?"},
			{"Jake", "The what?"},
